...
function(setup_coverage_flags)
    message(CHECK_START "Setup CXX Coverage flags")
    list(APPEND CMAKE_MESSAGE_INDENT "  ")

    # https://cmake.org/cmake/help/latest/variable/CMAKE_LANG_COMPILER_ID.html
    if(CMAKE_CXX_COMPILER_ID STREQUAL "Clang" AND CMAKE_CXX_COMPILER_FRONTEND_VARIANT STREQUAL "MSVC")
        message(STATUS "C++ compiler is MSVC-like Clang, Coverage not supported")
    elseif(CMAKE_CXX_COMPILER_ID STREQUAL "MSVC")
        message(STATUS "C++ compiler is Microsoft Visual Studio, Coverage not supported")
    elseif(CMAKE_CXX_COMPILER_ID STREQUAL "Clang")
        message(STATUS "C++ compiler is LLVM Clang, using clang flags")
        custom_clang_cxx_coverage_flags_init()
        set(COVERAGE_FLAGS ${CUSTOM_CLANG_CXX_COVERAGE_FLAGS})
    ...
    elseif(CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
        ...
        custom_gcc_cxx_coverage_flags_init()
        set(COVERAGE_FLAGS ${CUSTOM_GCC_CXX_COVERAGE_FLAGS})
    else()
        message(STATUS "Unknown compiler ID: ${CMAKE_CXX_COMPILER_ID}")
    endif()

    set(COVERAGE_CHECKED_FLAGS)
    foreach(flag ${COVERAGE_FLAGS})
        custom_check_compiler_linker_flag(${flag} res)
        if(res)
            set(COVERAGE_CHECKED_FLAGS "${COVERAGE_CHECKED_FLAGS} ${flag}")
            message(STATUS "[✔] ${flag}")
        else()
            message(STATUS "[✘] ${flag}")
        endif()
    endforeach()
    custom_build_type_set_base_flags(COVERAGE
      INIT_FROM DEBUG
      CXX_FLAGS ${COVERAGE_CHECKED_FLAGS}
    )
...
function(setup_sanitize_flags)
    ...
    custom_build_type_set_base_flags(SANITIZE
      INIT_FROM DEBUG
      CXX_FLAGS ${SANITIZE_CHECKED_FLAGS}
    )

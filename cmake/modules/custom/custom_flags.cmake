...
macro(custom_clang_cxx_coverage_flags_init)
    set(CUSTOM_CLANG_CXX_COVERAGE_FLAGS
      ################################################################
      # https://clang.llvm.org/docs/ClangCommandLineReference.html
      ################################
      # Optimization level
      -O0 # here to override -Og in default Debug build type
      ################################
      # Kind and level of debug information
      # -g # already in default Debug build type
      ################################################################
...
# GCC Coverage flags
macro(custom_gcc_cxx_coverage_flags_init)
    set(CUSTOM_GCC_CXX_COVERAGE_FLAGS
      ################################################################
      # https://gcc.gnu.org/onlinedocs/gcc/Optimize-Options.html
      ################################
      # Completely disables most optimization passes
      -O0 # here to override -Og in default Debug build type
      ################################################################
      ...
      ################################
      # Code instrumented for coverage analysis
      --coverage
      ################################
